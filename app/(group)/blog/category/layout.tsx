  ...
  return (
    <div className="flex gap-x-4 mx-4">
      <div className="flex flex-col w-full lg:w-2/3">
        <div className="text-sm breadcrumbs capitalize">
          <ul>
            ...
            <li>
              <Link href={`/blog/category/${decodeURI(slug)}`}>
                {decodeURI(slug)}
              </Link>
            </li>
          </ul>
      ...
      <div className="max-lg:hidden flex-1 space-y-8">
        <div className="border-25 rounded-box p-8 space-y-8">
          <Image
        ...
        <div className="rounded-box border-25 p-8 space-y-8">
          <h4 className="text-xl font-bold text-center">Explore Topics</h4>
          <div className="fb-border"></div>
